...
bot = TeleBot(api)
id_admin = "<ID_TELEGRAM_ADMIN>"


detector = MTCNN()

model = load_model('HasilTrainingvgg_kelas50.h5', compile=False)
Label_Nama = json.load(open("model_kelas50.json"))
